...
C         GREENWALD
 ...
 169  format(1x,'alphai=',e10.3,1x,'alphae=',e10.3,1x,'psepe=',f6.3,
     1       1x,'psepi=',f6.3,1x,'psepthe=',e10.3,1x,'psepthi=',e10.3)
...
C    2 yiondiv/(dnat*betag),yionsol/(dnat*betag),yionsolxpt/(dnat*betag),
C    3 yionrec1/(dnat*betag),dnrad/(dnat*betag)
